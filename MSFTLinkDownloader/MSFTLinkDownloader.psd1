#
# Module manifest for module 'MSFTLinkDownloader'
#
...
@{
    ...
    GUID = 'a7f80049-87c5-488e-91cb-8e8d354be66e'
    ...
    Description = 'Downloads files from Microsoft Links'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Microsoft', 'Official Links', 'Downloader','LinkID','download.microsfot.com')
